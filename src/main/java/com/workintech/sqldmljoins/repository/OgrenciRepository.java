...
public interface OgrenciRepository extends JpaRepository<Ogrenci, Long> {
    ...
    String QUESTION_4 = "SELECT o.sinif, COUNT(i.islemno) FROM ogrenci o JOIN islem i ON o.ogrno = i.ogrno WHERE o.sinif IN ('10A', '10B') GROUP BY o.sinif";
    ...
    String QUESTION_8 = "SELECT sinif, COUNT(*) FROM ogrenci WHERE sinif IS NOT NULL GROUP BY sinif";
